...
*Als Studierende der Universität Köln können Sie Endnote und Citavi [vergünstigt](https://rrzk.uni-koeln.de/software-multimedia/software/rahmenvertraege-und-campuslizenzen) beziehen (Stand Oktober 2021). Wenn Sie sich für kostenpflichtige Software entscheiden, sollten Sie vorab mit der Demo-Version prüfen, ob der LaTeX-Export reibungslos klappt und Sie mit dem Workflow zurecht kommen.*
